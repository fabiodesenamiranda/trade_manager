class AgentsController < ApplicationController
  ...
  def new
    @agent = Agent.new
    @agent.contacts.build # Adiciona um campo de contato ao formulário
  end
  ...
  private
    ...
    def agent_params
      params.expect(agent: [ :name, :phone, :email, :country, :state, :address, :number, :neighborhood, :city, :zip_code, :agent_type ])
    end
end
