class ImportProcess < ApplicationRecord
  belongs_to :supplier, class_name: "Agent", optional: false # Define supplier como obrigatório
  belongs_to :exporter, class_name: "Agent", optional: true # Adicione esta linha se precisar da associação exporter
  ...
  enum :incoterm, { fob: 0, cif: 1, ex_works: 2 }, prefix: :incoterm
